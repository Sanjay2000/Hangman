    ...
    * Har round ke baar, user ko uska guess kiya hua partial word
    ...
    while (reamining_lives>0):
        ...
        if letter in secret_word:
            ...
            letters_guessed.append(letter)
            print IMAGES[image_selection[total_lives-reamining_lives]]
            print "reamining_lives",reamining_lives
            reamining_lives-=1
            print ""
    else:
